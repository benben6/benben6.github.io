...
![图片](images/13/13-05.png)

class类执行的话会报错，而es5中的类和普通函数并没有本质区别，执行肯定是ok的。

二、class类不存在变量提升

![图片](images/13/13-06.png)

![图片](images/13/13-07.png)
