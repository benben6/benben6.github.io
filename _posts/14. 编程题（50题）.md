...
![图片](images/14/14-11.png)

输入： head = [3,2,0,-4], pos = 1 输出： 返回索引为 1 的链表节点 解释： 链表中有一个环，其尾部连接到第二个节点。

示例 2：

![图片](images/14/14-12.png)
...
## 40.给某个资源的链接，如 [https://www.baidu.com/index.html](https://www.baidu.com/index.html) ，请实现一个方法，获取该资源的后缀，如 html
