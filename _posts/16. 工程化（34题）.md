...
在开发阶段，本地地址为`[http://localhost:3000](http://localhost:3000)`，该浏览器发送一个前缀带有`/api`标识的请求到服务端获取数据，但响应这个请求的服务器只是将请求转发到另一台服务器中
...
![图片](images/16/16-18.png)

`webpack`的能力：

编译代码能力，提高效率，解决浏览器兼容问题

![图片](images/16/16-19.png)

模块整合能力，提高性能，可维护性，解决浏览器频繁请求文件的问题

![图片](images/16/16-20.png)

万物皆可模块能力，项目维护性增强，支持不同种类的前端模块类型，统一的模块化方案，所有资源文件的加载都可以通过代码控制

![图片](images/16/16-21.png)
...
![图片](images/16/16-31.png)

![图片](images/16/16-32.png)
